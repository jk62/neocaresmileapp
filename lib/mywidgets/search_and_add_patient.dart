...
// import 'package:neocare_dental_app/mywidgets/success_patient_add_for_appointment.dart';
...
// class SearchAndAddPatient extends StatefulWidget {
...
//   final Function(Patient)? onPatientSelectedForAppointment;
//   final Function(Patient)? onPatientAddedForAppointment;
//   final Function onNavigationBack;
//   final GlobalKey<State<BookAppointment>> bookAppointmentKey;

//   const SearchAndAddPatient({
//     Key? key,
//     required this.doctorId,
//     required this.clinicId,
//     required this.doctorName,
//     required this.patientService,
//     required this.onPatientSelectedForAppointment,
//     required this.selectedSlot,
//     required this.selectedDate,
//     required this.onPatientAddedForAppointment,
//     required this.bookAppointmentKey,
//     required this.onNavigationBack,
//   }) : super(key: key);

//   @override
//   State<SearchAndAddPatient> createState() => _SearchAndAddPatientState();
// }

// class _SearchAndAddPatientState extends State<SearchAndAddPatient> {
...
//     // Pass the selected patient back to the parent widget using the callback
//     if (widget.onPatientSelectedForAppointment != null) {
//       widget.onPatientSelectedForAppointment!(patient);
//     }
...
//     // Pass the selected patient back to the parent widget using the callback
//     if (widget.onPatientAddedForAppointment != null) {
//       widget.onPatientAddedForAppointment!(patient);
//     }
//     //Navigator.pop(context);
//     // Delay the execution of Navigator.pop(context) until the current frame is finished building
...
//             context,
//             MaterialPageRoute(
//               builder: (context) => SuccessPatientAddForAppointment(
...
//     devtools.log(
//         'Welcome to SearchAndAddPatient -buildSearchUI. addingNewPatient is $addingNewPatient');
